...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  // Create types (idempotent via DO block)
  ...
  // Add enum values (IF NOT EXISTS supported in PG 9.3+)
  await db.execute(sql`
    ALTER TYPE "public"."enum_footer_social_links_platform" ADD VALUE IF NOT EXISTS 'linkedin';
    ALTER TYPE "public"."enum_footer_social_links_platform" ADD VALUE IF NOT EXISTS 'twitter';
    ALTER TYPE "public"."enum_footer_social_links_platform" ADD VALUE IF NOT EXISTS 'snapchat';
    ALTER TYPE "public"."enum_footer_social_links_platform" ADD VALUE IF NOT EXISTS 'pinterest';
    ALTER TYPE "public"."enum_footer_social_links_platform" ADD VALUE IF NOT EXISTS 'whatsapp';
    ALTER TYPE "public"."enum_footer_social_links_platform" ADD VALUE IF NOT EXISTS 'telegram';
    ALTER TYPE "public"."enum_footer_social_links_platform" ADD VALUE IF NOT EXISTS 'other';
  `)
  ...
  await db.execute(sql`
    ...
    CREATE TABLE IF NOT EXISTS "homepage_services_cards" (
      "_order" integer NOT NULL,
      "_parent_id" integer NOT NULL,
      "id" varchar PRIMARY KEY NOT NULL,
    ...
    CREATE TABLE IF NOT EXISTS "homepage_pricing_plans_features" (
      "_order" integer NOT NULL,
    ...
    CREATE TABLE IF NOT EXISTS "homepage_pricing_plans" (
      "_order" integer NOT NULL,
      "_parent_id" integer NOT NULL,
      "id" varchar PRIMARY KEY NOT NULL,
    ...
    CREATE TABLE IF NOT EXISTS "homepage_pricing" (
      "id" serial PRIMARY KEY NOT NULL,
  ...
  // Add columns (IF NOT EXISTS supported in PG 9.6+)
  await db.execute(sql`
    ALTER TABLE "footer_social_links" ADD COLUMN IF NOT EXISTS "custom_icon" varchar;
    ALTER TABLE "footer_social_links" ADD COLUMN IF NOT EXISTS "label" varchar;
  `)
  ...
  // Create indexes
  await db.execute(sql`
    CREATE INDEX IF NOT EXISTS "footer_contact_items_order_idx" ON "footer_contact_items" USING btree ("_order");
    CREATE INDEX IF NOT EXISTS "footer_contact_items_parent_id_idx" ON "footer_contact_items" USING btree ("_parent_id");
    CREATE INDEX IF NOT EXISTS "homepage_services_cards_order_idx" ON "homepage_services_cards" USING btree ("_order");
    CREATE INDEX IF NOT EXISTS "homepage_services_cards_parent_id_idx" ON "homepage_services_cards" USING btree ("_parent_id");
    CREATE INDEX IF NOT EXISTS "homepage_services_cards_image_idx" ON "homepage_services_cards" USING btree ("image_id");
    CREATE INDEX IF NOT EXISTS "homepage_pricing_plans_features_order_idx" ON "homepage_pricing_plans_features" USING btree ("_order");
    CREATE INDEX IF NOT EXISTS "homepage_pricing_plans_features_parent_id_idx" ON "homepage_pricing_plans_features" USING btree ("_parent_id");
    CREATE INDEX IF NOT EXISTS "homepage_pricing_plans_order_idx" ON "homepage_pricing_plans" USING btree ("_order");
    CREATE INDEX IF NOT EXISTS "homepage_pricing_plans_parent_id_idx" ON "homepage_pricing_plans" USING btree ("_parent_id");
  `)
}
