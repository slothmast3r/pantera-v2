    ...
    data: {
      ...
      columns: [
        ...
        },
        {
          heading: 'Kontakt',
          links: [
            { label: '📍 Warszawa, Sadyba (ul. Powsińska 25)', href: '#' },
            { label: '📞 508 689 718', href: 'tel:+48508689718' },
            { label: '✉️ kontakt@pantera.waw.pl', href: 'mailto:kontakt@pantera.waw.pl' },
          ],
        },
      ],
      socialLinks: [
        { platform: 'facebook', url: 'https://facebook.com/pantera' },
        { platform: 'instagram', url: 'https://instagram.com/pantera' },
      ],
